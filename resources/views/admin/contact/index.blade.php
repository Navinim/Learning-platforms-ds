                                ...
                                <table class="display table table-bordered table-striped" id="dynamic-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td>{{$contact->email}}</td>
                                            <td>
                                                <button data-contact-id="{{ $contact->id }}" data-bs-toggle="modal" id="showbtn"
                                                    data-bs-target="#editModal" class="btn btn-primary mx-2"><i class="bx bx-bullseye"></i></button>
                                                <a href="{{route('contacts.destroy',$contact->id)}}" onclick="return confirm('Are you sure you want to delete this item?')" class="btn btn-danger mx-2"><i class="bx bx-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
            ...
            $('#editModal').on('show.bs.modal', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#contactSubject').text(response.subject);
