                ...
                <div class="col-sm-12">
                    <section class="card">
                        ...
                        <div class="card-title">
                            ...
                            <form id="addform" action="{{ route('practices.store') }}" enctype="multipart/form-data" method="POST">@csrf
                                <div class="form-group">
                                    <label for="course_category_id">Main Topic</label><sup>*</sup>
                                    <select class="form-select" name="practice_cate_id" aria-label="Default select example" required>
                                ...
                                <div class="form-group"> 
                                    ...
                                    <input type="text" class="form-control" name="answer" id="answer" placeholder="e.g. full stack developer" required>
                                </div>                              
